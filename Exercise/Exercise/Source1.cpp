...
//カスタムバーテックス
CUSTOMVERTEX CustomVertex[3]
{
	{10,10,1,1,0xffffff00,0,0},
	{100,10,1,1,0xffffabff,1,0},
	{100,100,1,1,0xffffafff,1,1},
};
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR lpCmdLine, int nCmdShow)
{
	...
	BuildDxDevice(hWnd_a,_T("Blank.jpg"));
...
VOID Draw()
{
	...
	// 頂点リストの描画
	pDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 1, CustomVertex, sizeof(CUSTOMVERTEX));
	//テクスチャ貼り付け終了
